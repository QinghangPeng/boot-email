package com.pqh.basic.email.response;

import com.fasterxml.jackson.annotation.JsonAnyGetter;
import com.fasterxml.jackson.annotation.JsonAnySetter;
import com.fasterxml.jackson.annotation.JsonIgnore;
import com.pqh.basic.email.error.IError;
import com.pqh.basic.email.vo.util.PageInfoVO;
...
public class RestResponse<T> {
    ...
    public static RestResponse success(Object data, PageInfoVO pageInfo) {
        return success(DEFAULT_DATAS_KEY, data, pageInfo);
    }


    public static RestResponse success(String key, Object data, PageInfoVO pageInfo) {
    ...
    private RestResponse page(PageInfoVO page) {
        this.pageIndex = Long.parseLong(""+page.getPageIndex());
        this.pageCount = Long.parseLong(""+page.getPageCount());
